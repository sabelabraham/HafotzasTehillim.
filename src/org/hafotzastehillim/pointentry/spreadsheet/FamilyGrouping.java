...
public class FamilyGrouping implements Selectable, Comparable<FamilyGrouping> {
	...
	public void attemptBind(Entry e1, Entry e2, Function<Entry, StringProperty> extractor, String name) {
		...
		if (!model.isIgnoreConflicts()) {
			...
			ButtonType button = DialogUtils.createDialog(new StackPane(grid), "Family Conflict", disable, ButtonType.OK)
