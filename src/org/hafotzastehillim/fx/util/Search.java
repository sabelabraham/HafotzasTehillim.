...
import static org.hafotzastehillim.fx.spreadsheet.Column.ID_NUMBER;
...
public class Search {
	...
	private static final int[] searchableColumns = new int[] { PHONE.getColumn(), ID_NUMBER.getColumn(), ADDRESS_NUMBER.getColumn(),
